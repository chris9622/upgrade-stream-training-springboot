package com.ecubit.training.tmdb;
        ...
        if(is != null) {
            try(
                ...
                while ((nextRecord = csvReader.readNext()) != null) {
                    ...
                    Movie movie = new Movie(title, overview, year, imdb, duration, rating,votes,gross);
                    ...
                    for(String g : genreNamesSet) {
                        Optional<Genre> optGenre = genres.stream().filter(gr -> gr.getTypeGenre().equalsIgnoreCase(g)).findFirst();
